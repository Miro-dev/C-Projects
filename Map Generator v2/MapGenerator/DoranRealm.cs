...
namespace Doran
{
    public partial class DoranRealm : Form
    {
        ...
        {
            MapGenerator(800, 700, 20, 500, 30, 100);
        }
        ...
        public void MapGenerator(int fieldWidth, int fieldHeight, int tileSide, int startingPointOfGrid_X, int startingPointOfGrid_Y, int iterations)
        {
